...
class FederalFilamentStorePage extends Page implements HasForms
{
    ...
    protected array $products = [
        ...
        [
            'id' => 3,
            'name' => 'Teclado Mecânico ShieldForce',
            'price' => 399.00,
            'category' => 'Eletrônicos',
            'image' => null,
        ],
        ...
        [
            'id' => 8,
            'name' => 'Cadeira Gamer Thunder Pro',
            'price' => 1299.00,
            'category' => 'Móveis',
            'image' => null,
        ],
        [
            'id' => 9,
            'name' => 'Mesa de Escritório Compacta',
            'price' => 599.99,
            'category' => 'Móveis',
            'image' => null,
        ],
        ...
        [
            'id' => 13,
            'name' => 'Quadro Decorativo Cyberpunk',
            'price' => 129.90,
            'category' => 'Decoração',
            'image' => null,
        ],
        ...
        [
            'id' => 15,
            'name' => 'Smartwatch ShieldForce Active',
            'price' => 599.90,
            'category' => 'Eletrônicos',
            'image' => null,
        ],
