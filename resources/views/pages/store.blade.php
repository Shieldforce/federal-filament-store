<x-filament::page class="!max-w-full px-0">
    ...
    <div class="w-full grid grid-cols-1 md:grid-cols-[1fr_280px] md:grid-flow-col gap-6"><x-filament::page class="!max-w-full px-0">

            <div class="w-full grid grid-cols-1 md:grid-cols-[280px_1fr] md:grid-flow-col gap-6">

                {{-- SIDEBAR DE FILTROS (AGORA À ESQUERDA) --}}
